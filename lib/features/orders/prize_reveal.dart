...
class _PrizeRevealState extends State<PrizeReveal>
  ...
  Widget build(BuildContext context) {
    ...
    final accent = prize.premium
        ? const Color(0xFFFFD58A) : const Color(0xFFB9A4FF);
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Container(
          ...
          child: Column(
            children: [
              Text(prize.premium ? 'PREMIUM COLLECTION' : 'YOUR COLLECTION',
                          ...
                          child: ClipRRect(
                            ...
                            child: prize.imageUrl == null || prize.imageUrl!.isEmpty
                              ? const Icon(Icons.card_giftcard_rounded,
                                  size: 72, color: Color(0xFF554074))
                              : Image.network(prize.imageUrl!, fit: BoxFit.contain,
                                  errorBuilder: (_, error, stack) => const Icon(
                                    Icons.card_giftcard_rounded, size: 72,
              ...
              Semantics(
                liveRegion: true,
                child: Text(prize.name, textAlign: TextAlign.center,
...
class _Rays extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < 16; i++) {
      ...
      canvas.drawLine(center + direction * (80 + progress * 15),
          center + direction * (92 + progress * 23), paint);
    }
  }
